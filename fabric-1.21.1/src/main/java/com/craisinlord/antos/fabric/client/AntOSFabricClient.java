...
public final class AntOSFabricClient implements ClientModInitializer {
    @Override public void onInitializeClient() {
        ...
        BuiltinItemRendererRegistry.INSTANCE.register(AntOSFabricContent.FLOPPY_DISK,
                (stack, displayContext, poseStack, buffers, light, overlay) ->
                        FloppyDiskRenderer.renderTexture(FloppyDiskRenderer.textureFor(stack), poseStack, buffers, light, overlay));
    }
}
